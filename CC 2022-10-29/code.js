...
// Integers -> p0 percent -> +num > 0 , aug inhabitants (coming and going) -> integer, p population(equal or surpass) -> + || null floating num +num > 0, 
// Return the number of entire years needed to get a population greater or equal to p (population)
...
function nbYear(p0, percent, aug, p) {
  // for loop
  // var variable to use outside for loop
  // Big O(n)
...
function nbYear(p0, percent, aug, p) {
  // for loop
  // var variable to use outside the for loop
