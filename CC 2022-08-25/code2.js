...
//P: Two strings - each containing at least two letters, no numbers, lowercase, no special characters at start or end, can have hyphens and spaces
//R: Boolean - true or false,

//SOLUTION:
//P: Get the start and end letters of the animals name
// Compare them in turn to the start and end letters of the dish they are bringing
