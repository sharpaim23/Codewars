...
//P: Can the arrays consist of only names, can numbers be applied
//R: The string saying hello and welcome to such city and state

//SOLUTION:
//P: Join the names
// template literals for the name, city, and state
// return 
// show work
