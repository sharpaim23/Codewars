...
//P: Will it ever be a string, always positive integer, will another child be ever be included
//R: How many years age the dad's age was twice as old as his son's age

//SOLUTION:
function twiceAsOld(dadYearsOld, sonYearsOld) {
  //P:dadyearsold sub 2
  //multiply sonsyearsold by 2
  //show work
