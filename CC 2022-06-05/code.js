...
//P:Can the object be empty, Can this possibly be turned into arrays, can the arrays be empty 
//R:The specific welcome according to the ip address

//SOLUTION:
function greet(language) {
  //P:Create an object of languages 
  //return langue default or the language the ip results show
  //show work
  const base = {
english: 'Welcome',
czech: 'Vitejte',
