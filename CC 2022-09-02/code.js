...
//P: Three ways to figure out if the person speaking is Nessie
//R: Create a code to decipher if it is the true Nessie

//SOLUTION:
//P: Regex
// All the expressions in an or layout
// Test s for all parameters
//Show workS
