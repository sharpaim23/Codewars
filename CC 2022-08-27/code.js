...
//Parameters: Is the string in all caps - no lower case letters within the string
//Results: All caps strings

//SOLUTION:
//Pseudocode: Own method
// This keyword to bind it to the string
// .toUppercase() to figure out if this (string) is uppercase
// Show work
