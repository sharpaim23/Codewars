...
//P: Numbers - rounded decimal places by two spaces, all valid numbers
//R: Return the number with two decimal places

//SOLUTION:
//P:
twoDecimalPlaces = (n) => Number.parseFloat(n).toFixed(2) * 1
